document.addEventListener('DOMContentLoaded', () => {
    ...
    // ==============================================
    //     BAGIAN 2: LOGIKA BIODATA DENGAN PAGINATION (DATA DIPERBARUI TOTAL)
    // ==============================================
    const allStudentsData = [
        ...
        { absen: "02", nama: "Ahmad Raditia", hobi: "Menulis cerita", motto: "Tulis kisahmu sendiri.", foto: "img/ahmad.jpg", instagram: "https://www.instagram.com/" },
        ...
        { absen: "06", nama: "Dewi Sekarsari", hobi: "Melukis pemandangan", motto: "Warna adalah senyuman alam.", foto: "img/dewi.jpg", instagram: "https://www.instagram.com/dewi_sekar" },
        ...
        { absen: "10", nama: "Khayyirah Nareswari", hobi: "Memasak kue", motto: "Manisnya hidup ada di tanganmu.", foto: "img/khayyirah.jpg", instagram: "https://www.instagram.com/khayyirah_n" },
        ...
        { absen: "12", nama: "M. Fajar Ar Rassyid", hobi: "Mempelajari sejarah", motto: "Masa lalu adalah guru terbaik.", foto: "img/fajar.jpg", instagram: "https://www.instagram.com/fajar_ar" },
        { absen: "13", nama: "M. Haikal", hobi: "Naik gunung", motto: "Puncak adalah bonus, perjalanan adalah proses.", foto: "img/haikal.jpg", instagram: "https://www.instagram.com/" },
        ...
        { absen: "16", nama: "Nyimas Daiva Khanza Nabila", hobi: "Menari", motto: "Ekspresikan dirimu lewat gerakan.", foto: "img/nyimas.jpg", instagram: "https://www.instagram.com/nyimas_daiva" },
        ...
        { absen: "18", nama: "Rasya Adilah Alfarizi", hobi: "Bermain gitar", motto: "Musik adalah suara perasaan.", foto: "img/rasyaa.jpg", instagram: "https://www.instagram.com/rasya_adilah" },
        ...
        { absen: "20", nama: "Rayhan Azril Alifian", hobi: "Mengoleksi action figure", motto: "Setiap koleksi punya cerita.", foto: "img/rayhan.jpg", instagram: "https://www.instagram.com/rayhan_azril" },
        ...
        { absen: "22", nama: "Risa", hobi: "Belajar bahasa baru", motto: "Beda bahasa, satu dunia.", foto: "img/risa.jpg", instagram: "https://www.instagram.com/risa_" },
        ...
        { absen: "24", nama: "Tiara Putri Azzahra", hobi: "Menyanyi", motto: "Suarakan isi hatimu.", foto: "img/tiara.jpg", instagram: "https://www.instagram.com/tiara_putri" },
        { absen: "25", nama: "Tiffany Ayu Dwi Winarti", hobi: "Yoga", motto: "Ketenangan datang dari dalam.", foto: "img/tiffany.jpg", instagram: "https://www.instagram.com/@bananaluv_you" },
        { absen: "26", nama: "Vivi Oktavia", hobi: "Membuat kerajinan tangan", motto: "Ciptakan sesuatu yang indah.", foto: "img/vivi.jpg", instagram: "https://www.instagram.com/vivi_oktavia" },
        { absen: "27", nama: "Yasmin", hobi: "Volunteering", motto: "Berbagi itu peduli.", foto: "img/yasmin.jpg", instagram: "https://www.instagram.com/" },
        { absen: "28", nama: "Zia Aliza Putri", hobi: "Merawat hewan peliharaan", motto: "Cinta tanpa syarat.", foto: "img/zia.jpg", instagram: "https://www.instagram.com/zia_aliza" }
    ];
    ...
    // ==============================================
    //     BAGIAN 6: LOGIKA ANIMASI SCROLL & RATING
    // ==============================================
    const animatedSection = document.querySelector('.struktur-kelas');
    if (animatedSection) {
        ...
        scrollObserver.observe(animatedSection);
    }
